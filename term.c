 ...
 */
static bool symbol_is_valid(sstring const symbol) { return false; }

term term_create(sstring symbol) { return NULL; }
...
bool term_contains_symbol(term t, sstring symbol) { return false; }

term term_get_argument(term t, int pos) { return NULL; }

term term_extract_argument(term t, int pos) { return NULL; }

term term_copy(term t) { return NULL; }

term term_copy_translate_position(term t, term *loc) { return NULL; }

void term_replace_copy(term t_destination, term t_source) {}

int term_compare(term t1, term t2) { return 0; }

struct term_argument_traversal_struct {
  term_list tls;
};

term_argument_traversal term_argument_traversal_create(term t) { return NULL; }
